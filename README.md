...
## Installation
```shell
go get github.com/x-x-x-Ilya/binance-connector-go
```

To reference the package in your code, use the following import statement:
```golang
import (
    "github.com/x-x-x-Ilya/binance-connector-go"
)
```
## Authentication
```go
...
import (
	...
	binance_connector "github.com/x-x-x-Ilya/binance-connector-go"
)
